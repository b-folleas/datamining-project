...
def choose_rand_image(dataset, number_of_files):
    ...
    :param dataset: A dataset containing the files which will be given into a list of images.
    :param number_of_files: Int to define the number of files to pick from the dataset.
